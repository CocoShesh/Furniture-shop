...
function Header() {
  ...
  return (
    <>
      <header>
        <nav className=" flex justify-between items-center border-b-2 lg:px-20 pb-2 fixed  text-gray-900 top-0 left-0 right-0 z-20  bg-white max-lg:px-5 max-sm:px-5">
