...
function Products() {
  ...
  return (
    <div>
      <div className="mx-5  px-4 py-16 sm:px-6 sm:py-24   lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900">
          Products we are proud of
        </h2>

        <div className="mt-6 grid lg:grid-cols-4  max-lg:grid-cols-3  gap-x-6 gap-y-10  max-sm:grid-cols-auto max-md:grid-cols-2   xl:gap-x-8">
